...
const DADOS_CIENTISTAS = [
    ...
    { 
      ...
      "fonte" : "Emmy Noether (1882-1935), Archived",
    ...
    { 
      ...
      "fonte" : "Indisponível no momemento",
      "bandeira_url": "img/estados unidos.png", 
    ...
    { 
      ...
      "bandeira_url": "img/estados unidos.png", 
      "fonte" : "Science History Institute, Via Wikimedia Commons",
    ...
    { 
      ...
      "fonte" : "James S. Davis, Public domain, via Wikimedia Commons",
      "bandeira_url": "img/estados unidos.png", 
    ...
    { 
      ...
      "fonte" : "Alfred Edward Chalon, Public domain, via Wikimedia Commons",
    ...
    { 
      ...
      "fonte" : "Employee(s) of MGM, Public domain, via Wikimedia Commons",
    ...
    { 
      ...
      "fonte" : "Fotograv. - Generalstabens Litografiska Anstalt Stockholm, Public domain, via Wikimedia Commons",
    ...
    { 
      ...
      "fonte" : "Rosalind Franklin : CSHL, derivative work Lämpel, CC BY-SA 4.0, via Wikimedia Commons",
      "bandeira_url": "img/reino unido.jpg", 
    ...
    { 
      ...
      "fonte" : "Smithsonian Institution from United States, No restrictions, via Wikimedia Commons",
      "bandeira_url": "img/estados unidos.png", 
    ...
    { 
      ...
      "fonte" : "David Blackwell : George M. Bergman, CC BY-SA 4.0, via Wikimedia Commons",
      "bandeira_url": "img/estados unidos.png", 
    ...
    
  {
    ...
    "fonte" : "Elliott & Fry, Public domain, via Wikimedia Commons",
    "bandeira_url": "img/reino unido.jpg",
...

  {
    ...
    "imagem_perfil_url": "img/Stephen_Hawking.jpg",
